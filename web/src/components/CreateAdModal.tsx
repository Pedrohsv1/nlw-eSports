  ...
  return (
    <Dialog.Portal>
          <Dialog.Overlay className='bg-black/60 inset-0 fixed'>
            <Dialog.Content className='shadow-black/25 rounded-lg w-[480px] fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
              <Dialog.Title className='text-3xl text-white font-black'>Publique um anúncio</Dialog.Title>
                <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
                  <div className='flex-col flex gap-2'>
                    ...
                    name='game'
                    id='game'
                    className='flex bg-zinc-900 py-3 px-4 rounded text-sm placeholder:text-zinc-500 appearance-none'
                    >
                  ...
                  <div className='flex-col flex gap-2'>
                    <label htmlFor="name" className='flex-col flex gap-2'>Seu nome (ou nickname)</label>
                  ...
                  <div className='flex gap-6'>
                    <div className='flex-col flex gap-2'>
                      <label htmlFor="yearsDays">Quando costuma jogar?</label>
                        <ToggleGroup.Root 
                          type="multiple" 
